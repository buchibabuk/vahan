...
public class DefacementImplementation {
     ...
     * @author Kartikey Singh
     */
    public void insertIntoDefacement(TransactionManager tmgr, DefacementDobj dobj, String regn_no, String stateCode, int offCode, String empCode) throws VahanException {
        PreparedStatement ps = null;
        String sql = null;
        int i = 1;
        try {
