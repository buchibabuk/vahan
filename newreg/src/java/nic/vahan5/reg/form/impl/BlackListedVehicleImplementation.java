...
public class BlackListedVehicleImplementation {
    ...
    public Vector getCurrentStatus(String numberEntered, String search_by_regn_no) throws VahanException {
        ...
        try {
            ...
            while (rsReleased.next()) {
                ...
                releasedlistdobj.setComplaindt(nic.vahan.CommonUtils.Utility.convertdateFormatString(rsReleased.getString("complain_dt")));
                ...
                releasedlistdobj.setActiondt(nic.vahan.CommonUtils.Utility.convertdateFormatString(rsReleased.getString("action_dt")));
     ...
     * @author Kartikey Singh
     */
    public void insertIntoVhBlacklistFromVtBlacklist(TransactionManager tmgr, String regn_no, String state_cd, int off_cd, String rcpt_no, String empCode) throws VahanException {
        PreparedStatement ps;
        String sql;
        try {
            if ("TN".contains(state_cd)) {
