 ...
 */
public class VehicleTrackingDetailsImplementation {

    private static final Logger LOGGER = Logger.getLogger(VehicleTrackingDetailsImplementation.class);
     ...
     * @author Kartikey Singh
     */
    public void insertVhaVehicleTrackFromVaVehicleTrack(VehicleTrackingDetailsDobj dobj, String state_cd, int off_cd, TransactionManager tmgr,
     ...
     * @author Kartikey Singh
     */
    public void insertVtVehicleTrackFromVaVehicleTrack(VehicleTrackingDetailsDobj dobj, String state_cd, int off_cd, TransactionManager tmgr,
            String empCode) throws VahanException {
        PreparedStatement ps = null;
        String sql = null;
        try {
     ...
     * @author Kartikey Singh
     */
    public void approveStatusVehTrackDetails(VehicleTrackingDetailsDobj dobj, String state_cd, int off_cd, TransactionManager tmgr, String empCode) throws VahanException {
        try {
            insertVhaVehicleTrackFromVaVehicleTrack(dobj, state_cd, off_cd, tmgr, empCode);
            insertVtVehicleTrackFromVaVehicleTrack(dobj, state_cd, off_cd, tmgr, empCode);
            ServerUtility.deleteFromTable(tmgr, "", dobj.getAppl_no(), TableList.VA_VLTD);
        } catch (VahanException | SQLException e) {
            LOGGER.error(e.toString() + " " + e.getStackTrace()[0] + "-Appl_no-" + dobj.getAppl_no());
            throw new VahanException("Approval Error:" + TableConstants.SomthingWentWrong);
        }
