...
import static nic.vahan.form.impl.ExArmyImpl.insertIntoVhaExArmy;
...
public class ExArmyImplementation {
     ...
     * Author: Kartikey Singh
     */
    public static void insertIntoVhaExArmy(TransactionManager tmgr, String appl_no, String empCode) {
        PreparedStatement ps = null;
        String sql = null;
        try {
     ...
     * @author Kartikey Singh
     */
    public static void insertIntoVtFromVaOwnerExArmy(TransactionManager tmgr, Status_dobj dobj, String userStateCode, int selectedOffCode) throws SQLException {
        PreparedStatement ps = null;
        String sql = null;
