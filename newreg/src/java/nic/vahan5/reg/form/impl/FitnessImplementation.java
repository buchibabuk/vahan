...
public class FitnessImplementation {
     ...
     */
    public static void insertOrUpdateFitnessMoveFile(TransactionManager tmgr, String regn_no, String chasisNo,
            FitnessDobj fitness_dobj, ArrayList fitCheckList, String stateCd, int offCd, String empCode) throws VahanException, SQLException {
        for (int i = 0; i < fitCheckList.size(); i++) {
            if (fitCheckList.get(i).equals("N")) {
                /*
                 * 14th position is faremeter field and is mandatory only if fare_mtr_no is not null or non empty
        ...
        insertOrUpdateFitness(tmgr, regn_no, chasisNo, fitness_dobj, fitCheckList, stateCd, offCd, empCode);
    }
    ...
    public static void insertOrUpdateFitness(TransactionManager tmgr, String regn_no, String chasisNo,
        ...
        if (rs.next()) {
            insertVhaFitness(tmgr, fitness_dobj.getAppl_no(), empCode);
            updateVaFitness(tmgr, regn_no, chasisNo, fitness_dobj, fitCheckList);
        } else {
            insertVa_fitness(tmgr, regn_no, chasisNo, fitness_dobj, fitCheckList, stateCd, offCd);
        }
     ...
     * @author Kartikey Singh
     */
    public static void insertVhaFitness(TransactionManager tmgr, String appl_no, String empCode) throws VahanException, SQLException {
     ...
     * @author Kartikey Singh
     */
    public static void moveFromVtFitnessToVhFitness(String applNo, String regnNo, String stateCd, int offCd, TransactionManager tmgr, String empCode) throws VahanException {
     ...
     * @author Kartikey Singh
     */
    public static void moveFromVaFitnessToVTFitness(TransactionManager tmgr, String appl_no, String stateCode) throws SQLException {
     ...
     * @author Sai
     */
    public static int getNewFitnessUpto(Owner_dobj own_dobj, SessionVariablesModel sessionVariablesModel) throws VahanException {
        ...
        Exception e = null;
        VehicleParameters vehParameters = FormulaUtilities.fillVehicleParametersFromDobj(own_dobj, sessionVariablesModel);
     ...
     * @author Kartikey Singh
     */
    public static void moveFromVtSpeedGovToVhSpeedGovTo(String applNo, String regnNo, String stateCd, int offCd, TransactionManager tmgr, String empCode) throws VahanException {
...
//to get SLD from Service
     ...
     * @author Kartikey Singh
     */
    public static void insertUpdateVaSpeedGovernor(SpeedGovernorDobj dobj, TransactionManager tmgr, String empCode) throws VahanException {
     ...
     * @author KArtikey Singh
     */
    public static void insertIntoVaSpeedGovernor(SpeedGovernorDobj dobj, TransactionManager tmgr, String empCode) throws VahanException {
     ...
     */
    public static void insertIntoVhaSpeedGovernor(String applNo, TransactionManager tmgr, String empCode) throws VahanException {
        String sql = "INSERT INTO " + TableList.VHA_SPEED_GOVERNOR
                + " SELECT current_timestamp, ?, * FROM " + TableList.VA_SPEED_GOVERNOR + " WHERE appl_no=? ";
        try {
            int i = 1;
     ...
     * @author Kartikey Singh
     */
    public void insertOrUpdateInspection(TransactionManager tmgr, InspectionDobj inspectionDobj, String empCode) throws Exception {
        ...
        InspectionDobj isInspecDobjExist = getVaInspectionDobj(inspectionDobj.getAppl_no());
        if (isInspecDobjExist != null) {
            insertIntoVhaInspection(tmgr, inspectionDobj.getAppl_no(), empCode);
            updateVaInspection(tmgr, inspectionDobj);
        } else {
            insertVaInspection(tmgr, inspectionDobj);
        }
     ...
     * @author Kartikey Singh
     */
    public void insertOrUpdateVaReflectiveTape(TransactionManager tmgr, ReflectiveTapeDobj refDobj, String empCode) throws Exception {
     ...
     * @author Kartikey Singh
     */
    public void moveFromVtReflectiveTapeToVhReflectiveTape(String regnNo, String stateCd, TransactionManager tmgr, String empCode) throws VahanException {
