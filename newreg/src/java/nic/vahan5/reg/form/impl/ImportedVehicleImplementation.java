...
import static nic.vahan.form.impl.ImportedVehicleImpl.insertIntoVhaImpVeh;
...
public class ImportedVehicleImplementation {
     ...
     * Author: Kartikey Singh
     */
    public static void insertIntoVhaImpVeh(TransactionManager tmgr, String appl_no, String empCode) {
        PreparedStatement ps = null;
        String sql = null;
        try {
     ...
     * @author Kartikey Singh
     */
    public static void insertIntoVtFromVaImportedVeh(TransactionManager tmgr, Status_dobj dobj, String userStateCode, int selectedOffCode) throws SQLException {
        PreparedStatement ps = null;
        String sql = null;
