...
//                parameterValue = appl_no;
     ...
     * @author Kartikey Singh
     */
    public static void insertIntoHPAHistory(TransactionManager tmgr, String appl_no, int sr_no,
     ...
     * @author Kartikey Singh
     */
    public static void insertIntoHPAHistory(TransactionManager tmgr, String appl_no, String empCode) throws SQLException, Exception {
        PreparedStatement ps = null;
        String sql = null;
     ...
     * @author Kartikey Singh
     */
    public static void insertUpdateHPA(TransactionManager tmgr, List<HpaDobj> hpa_dobj_list, String stateCd, int offCd,
     ...
     * @author Kartikey Singh
     */
    public static void insertInto_HPT_History(TransactionManager tmgr, String appl_no, String empCode) throws SQLException, Exception {
        PreparedStatement ps = null;
        String sql = null;
     ...
     * @author Kartikey Singh
     */
    public static void insertDeleteFromVaHpa(TransactionManager tmgr, String applNo, String empCode) throws SQLException {
        PreparedStatement psVaHpa = null;
        PreparedStatement psVhaHpa = null;
        String vaHpasql = null;
        String vhaHpasql = null;
     ...
     * @author Kartikey Singh
     */
    public int maxHypothecationNo(String applNo, String regnNo, int purCd, String stateCode, int selectedOffCode) {
        TransactionManager tmgr = null;
        PreparedStatement ps = null;
        RowSet rs = null;
        int total = 1;
