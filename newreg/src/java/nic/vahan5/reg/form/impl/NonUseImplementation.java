...
import static nic.vahan.form.impl.NonUseImpl.getTaxAmount;
 ...
 */
public class NonUseImplementation {
    private static final Logger LOGGER = Logger.getLogger(NonUseImplementation.class);
    ...
    public void insertNonUseDetails(TransactionManager tmgr, NonUseDobj dobj, Status_dobj statusDobj, TmConfigurationNonUseDobj configDobj) throws VahanException {
        ...
        try {
            ...
            if (statusDobj.getPur_cd() == TableConstants.VM_MAST_NON_USE) {
                ...
                if (configDobj != null && configDobj.isVehicle_inspect_for_removalshift() && (dobj.getValueOfRadioEvent().equalsIgnoreCase("C") || dobj.getValueOfRadioEvent().equalsIgnoreCase("NC"))) {
                    i = 1;
                    sql = "INSERT INTO " + TableList.VA_NON_USE_RESTORE_REMOVE + "(\n"
                            + "            state_cd, off_cd, appl_no, regn_no, exem_fr, exem_to, exem_by, \n"
                            + "            perm_no, perm_dt, remark, deal_cd,"
    ...
    public Date getTaxUpto(String regn_no) throws VahanException {
        ...
        String sql = "";
        try {
            tmgr = new TransactionManager("getTaxUpto");
     ...
     * @author Kartikey Singh
     */
    public void insertInVhNonUseAdjustFromVtNonUseAdjust(NonUseDobj dobj, TransactionManager tmgr, String empCode, String stateCode) throws VahanException {
        PreparedStatement ps = null;
        try {
            String sql = "INSERT INTO " + TableList.VH_NON_USE_TAX_ADJUST + "(\n"
                    + " state_cd, off_cd, appl_no, regn_no, exem_fr, exem_to, exem_by, \n"
     ...
     * @author Kartikey Singh
     */
    public void deleteFromVtNonUseAdjust(NonUseDobj dobj, TransactionManager tmgr, String stateCode) throws VahanException {
        PreparedStatement ps = null;
        try {
            String sql = " delete  from " + TableList.VT_NON_USE_TAX_ADJUST + " "
                    + " where regn_no=?  and state_cd=? ";
