...
public class ApplicationInwardImplementation {
    ...
    /*
        @author Kartikey Singh
    */
    public String taxPaidStatusForSmartCard(String regNo, TmConfigurationDobj confg, Owner_dobj dobj, int purCd, TransactionManager tmgr, SessionVariablesModel sessionVariablesModel) throws Exception {
        String taxPaidStatus = "";
        taxPaidStatus = ServerUtility.getTaxStatus(regNo, tmgr, confg, dobj, purCd, sessionVariablesModel);
        return taxPaidStatus;
    }
    ...
    /*
        @author Kartikey Singh
    */
    public boolean taxPaidOrClearedStatusOnVehType(String regNo, String stateCode, int selectedOffCode) throws Exception {
        ...
        try {
            ...
            taxPaid = ServerUtility.taxPaidInfo(false, regNo, 58, stateCode);
     ...
     * @author Kartikey Singh
     */
    public void updateApprovedStatusForOnlineAppl(TransactionManager tmgr, Status_dobj dobj, String clientIpAddress) throws SQLException {
        PreparedStatement ps = null;
        String sql = null;
