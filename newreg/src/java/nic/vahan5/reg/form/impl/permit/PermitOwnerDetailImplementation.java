 ...
 */
public class PermitOwnerDetailImplementation {

    private static final Logger LOGGER = Logger.getLogger(PermitOwnerDetailImplementation.class);
     ...
     * @author Kartikey Singh
     */
    public PermitOwnerDetailDobj set_VA_Owner_permit_to_dobj(String appl_no, String regn_no, String stateCode) {
        TransactionManager tmgr = null;
        PreparedStatement ps = null;
        String query = "";
        PermitOwnerDetailDobj owner_dobj = null;
