...
import static nic.vahan.form.impl.permit.PermitImpl.entryAlreadyDoneForLoi;
 ...
 */
public class PermitImplementation {
    private static final Logger LOGGER = Logger.getLogger(PermitImplementation.class);
     ...
     * @author Kartikey Singh
     */
    public void insertVtNewLoiDetails(String regn_no, String newLoiNo, TransactionManager tmgr, String userStateCode, int selectedOffCode) throws VahanException {
        PreparedStatement ps = null;
        try {
