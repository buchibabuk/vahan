...
public class NewVehicleNo {

    private static Logger LOGGER = Logger.getLogger(NewVehicleNo.class);
    ...
    public String generateAssignNewRegistrationNo(int offCd, int action_cd,
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (vehParameters != null) {
                    if (!isCondition(replaceTagValues(rs.getString("condition_formula"), vehParameters), "generateAssignNewRegistrationNo")) {
                        return null;
                    }
                }
            }
...
/// get the regn_no to be allotted from vt_fancy_register
    ...
    public void asignAndUpdateNewVehicleNo(String regnNo, String applNo, String state_cd, int offCd, String status, String remark, TransactionManager tmgr) throws VahanException {
        ...
        try {
            ...
            RowSet rs1 = tmgr.fetchDetachedRowSet_No_release();
            if ((auctionDobj != null && auctionDobj.getRegnNo() != null && !auctionDobj.getRegnNo().equals("NEW")) || (rs1.next())) {
                ...
                if (Util.getUserStateCode().equalsIgnoreCase("GJ")) {
                    Date regnDate = null;
