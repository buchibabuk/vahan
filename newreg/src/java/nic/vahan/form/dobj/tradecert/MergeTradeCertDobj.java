 ...
 * @author ManuSri
 */
public class MergeTradeCertDobj {

    private static final Logger LOGGER = Logger.getLogger(MergeTradeCertDobj.class);
    /**
    ...
    private String newMergeApplNo;
    private String certNo;
    private String newMergeCertNo;
     ...
     */
    public MergeTradeCertDobj copy(MergeTradeCertDobj dobj) {
        dobj.setApplNo(this.getApplNo());
        dobj.setNewMergeApplNo(this.getNewMergeApplNo());
        dobj.setCertNo(this.getCertNo());
        dobj.setNewMergeCertNo(this.getNewMergeCertNo());
    ...
    /**
     * @return the newMergeApplNo
     */
    public String getNewMergeApplNo() {
        return newMergeApplNo;
    }

    /**
     * @param newMergeApplNo the newMergeApplNo to set
     */
    public void setNewMergeApplNo(String newMergeApplNo) {
        this.newMergeApplNo = newMergeApplNo;
    }
    ...
    /**
     * @return the newMergeCertNo
     */
    public String getNewMergeCertNo() {
        return newMergeCertNo;
    }

    /**
     * @param newMergeCertNo the newMergeCertNo to set
     */
    public void setNewMergeCertNo(String newMergeCertNo) {
        this.newMergeCertNo = newMergeCertNo;
    }
