 ...
 * @author Deepak
 */
public class RejectedFileReportDO implements Serializable {
    ...
    private List<RejectedFileReportDO> filelist = new ArrayList();
    ...
    public List<RejectedFileReportDO> getFilelist() {
        return filelist;
    }

    public void setFilelist(List<RejectedFileReportDO> filelist) {
