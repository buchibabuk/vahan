 ...
 * @author Deepak
 */
public class FilePendingReportDO implements Serializable {

    private int srNo;
    private String registrationDate;
    private String regnDate;
    private String fileNo;
    private List<FilePendingReportDO> filelist = new ArrayList();
    ...
    public List<FilePendingReportDO> getFilelist() {
        return filelist;
    }

    public void setFilelist(List<FilePendingReportDO> filelist) {
