 ...
 * @author afzal
 */
@ManagedBean(name = "RtnRCDispByHandReportBean")
@ViewScoped
public class ReturnRCDispatchByHandReportBean implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(ReturnRCDispatchByHandReportBean.class);
    ...
    private List<DownloadDispatchDobj> returnRCDispatchByHandReportDobjList = new ArrayList<>();
    ...
    public ReturnRCDispatchByHandReportBean() {
        ...
        if ((radipBtnValue != null && !"".contains(radipBtnValue)) && ("HANDEDOVERDT".contains(radipBtnValue))) {
        ...
        returnRCDispatchByHandReportDobjList = PrintDocImpl.getReturnRCDispatchByHandReportDetails(sessionVariables.getStateCodeSelected(), sessionVariables.getOffCodeSelected(), enterNo, from_date, to_date, radipBtnValue);
        if (!returnRCDispatchByHandReportDobjList.isEmpty()) {
            DownloadDispatchDobj LastRowdobj = returnRCDispatchByHandReportDobjList.get(returnRCDispatchByHandReportDobjList.size() - 1);
    ...
    /**
     * @return the returnRCDispatchByHandReportDobjList
     */
    public List<DownloadDispatchDobj> getReturnRCDispatchByHandReportDobjList() {
        return returnRCDispatchByHandReportDobjList;
    }

    /**
     * @param returnRCDispatchByHandReportDobjList the
     * returnRCDispatchByHandReportDobjList to set
     */
    public void setReturnRCDispatchByHandReportDobjList(List<DownloadDispatchDobj> returnRCDispatchByHandReportDobjList) {
        this.returnRCDispatchByHandReportDobjList = returnRCDispatchByHandReportDobjList;
    }
