...
@ManagedBean(name = "form21Bean")
@ViewScoped
public class Form21Bean implements Serializable {
    ...
    private static final Logger LOGGER = Logger.getLogger(Form21Bean.class);
    ...
    public Form21Bean() throws VahanException {
        try {
            ...
            if (applNo != null && printType != null && printType.equals("FORM21")) {
                dobj = dealer_report_impl.getForm21Data(applNo);
            } else if (printType != null && printType.equals("FORM21AfterApproval")) {
    ...
    public String printReports(String printType) throws VahanException {
        return ServerUtil.printReports(printType, getApplNo(), getPurCd(), regnNo);
    }
