...
public class OnlinePayImpl {

    private static final Logger LOGGER = Logger.getLogger(OnlinePayImpl.class);
            ...
            for (OnlinePayDobj taxDobj : dtlDobjList) {
                if (!taxDobj.getPeriodFrom().equals("")) {
                    ...
                    if (!CommonUtils.isNullOrBlank(vehicleType) && (vehicleType.equalsIgnoreCase("BalanceFee") || vehicleType.equalsIgnoreCase("ONLINETAX"))) {
                        ...
                        taxClearImpl.updateAppl_noInVt_Refund_Excess(taxDobj.getApplNo(), taxDobj.getPurCd(), taxDobj.getRegnNo(), TableConstants.TM_ROLE_BALANCE_FEE_TAX_COLLECTION, tmgr);
                    }
                }
            }
