...
/**
 *
 * Implementation Class for All Tax related operations
 *
 * @author Prashant Kumar Singh
 */
public class TaxServer_Impl {

    private static final Logger LOGGER = Logger.getLogger(TaxServer_Impl.class);
...
//    }
    ...
    public Date getTaxFromUptoDate(String regnNo, int taxPurCd) {
        ...
        String whereIam = "TaxServer_Impl.getTaxFromUptoDate";
...
//            FeeImpl.PaymentGenInfo paymentInfo = feeImpl.getPaymentInfo(listTaxDobj, feeDraftDobj, userChg);
    ...
    private static List<SelectItem> getListTaxModes(Owner_dobj ownerDobj, int pur_cd, VehicleParameters vehicleParameters) throws VahanException {
        String[] taxModes = TaxServer_Impl.getAvailalableTaxModes(ownerDobj, pur_cd, vehicleParameters);
