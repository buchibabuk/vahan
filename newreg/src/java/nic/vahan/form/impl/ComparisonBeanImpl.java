...
public class ComparisonBeanImpl implements Serializable {

    private static org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(ComparisonBeanImpl.class);

    public ComparisonBeanImpl() {
    }
