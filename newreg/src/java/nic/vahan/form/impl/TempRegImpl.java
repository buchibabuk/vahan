...
public class TempRegImpl {
    ...
    public static String update_New_Status(int role, Owner_dobj owner_dobj, FitnessDobj fitness_dobj, ArrayList fitCheckList,
            ...
            AxleDetailsDobj axle_dobj, RetroFittingDetailsDobj cng_dobj, int actionCode, Owner_temp_dobj ownerTempDobjPrev, SessionVariables sessionVariables) throws VahanException {
        ...
        try {
            ...
            if ((role == TableConstants.TM_ROLE_ENTRY
                ...
                if (TableConstants.STATUS_COMPLETE.equals(status_dobj.getStatus())) {
                    ...
                    parameters.setACTION_CD(actionCode);
                    boolean isValidForRegistration = ServerUtil.validateVehicleNorms(owner_dobj, purCd, parameters, tmConf.getTmConfigDealerDobj());
                    ...
                    ServerUtil.saveVaOwnerDisclaimerDetails(owner_dobj, tmgr, Util.getEmpCode(), actionCode);
                    if (TableConstants.TM_TMP_RC_APPROVAL == actionCode || TableConstants.TM_ROLE_DEALER_TEMP_APPROVAL == actionCode) {
                        ServerUtil.updateApplNoOfBSIVChassis(owner_dobj, tmgr, purCd);
                    }
                }
