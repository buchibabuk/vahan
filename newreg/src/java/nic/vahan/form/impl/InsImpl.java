...
//                } else {
    ...
    public static void insertIntoInsurance(TransactionManager tmgr, InsDobj dobj, String appl_no, String regn_no, String stateCd, int offCd) throws VahanException {
        PreparedStatement ps = null;
        String sql = null;
        try {
