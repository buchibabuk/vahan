...
{
    var flag = true;
    var capcha = document.getElementById("tf_CAPCHA").value;
    var cm_BANK_NAME = document.getElementById("cm_BANK_NAME").value;
    if (cm_BANK_NAME ===null || cm_BANK_NAME === "" || cm_BANK_NAME === "-1")
    {
        flag = false;
        alert("Select Bank !");
    }
    ...
    else if (capcha.length <= 4)
    {
        flag = false;
        document.getElementById("tf_CAPCHA").value = "";
...
function checkEntry() {
    var reg1 = document.getElementById("ptf_REGN_NO1").value;
    var reg2 = document.getElementById("ptf_REGN_NO2").value;
    var chasino = document.getElementById("ptf_CHASI_NO").value;
    ...
    else if (reg1 == null || reg1 == "")
    {
        ...
        document.getElementById("ptf_REGN_NO1").focus();
        return false;
    }
    else if (reg2 == null || reg2 == "")
    {
        alert(" Please enter Series part");
        document.getElementById("ptf_REGN_NO2").focus();
        return false;
    ...
    } else if (chasino == null || chasino == "")
    {
        ...
        document.getElementById("ptf_CHASI_NO").focus();
        return false;
    } else if (capcha == null || capcha == "")
    {
